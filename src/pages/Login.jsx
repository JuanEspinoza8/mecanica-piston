...
import { Mail, Lock, LogIn, Loader2, Eye, EyeOff, Wrench } from 'lucide-react';
...
export default function Login() {
  ...
  if (showSplash) {
    return (
      <div className="fixed inset-0 bg-neutral-950 flex flex-col items-center justify-center z-[200] overflow-hidden">
        ...
        {/* Icono de Pistón animado */}
        <div className="relative mb-8">
          <div className="w-24 h-24 border-4 border-red-600/30 rounded-full flex items-center justify-center animate-spin" style={{ animationDuration: '3s' }}>
            <div className="w-20 h-20 border-4 border-transparent border-t-red-600 rounded-full"></div>
          </div>
  ...
  // ===================== LOGIN SCREEN =====================
  return (
    <div className="fixed inset-0 bg-neutral-950 flex items-center justify-center p-4 overflow-hidden">
      
      {/* Fondo decorativo */}
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-red-600/5 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2"></div>
        <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-red-500/5 rounded-full blur-3xl translate-y-1/2 -translate-x-1/2"></div>
        ...
        <div className="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-red-600/20 to-transparent"></div>
      </div>
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-10">
          <div className="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-gradient-to-br from-red-600 to-red-700 shadow-lg shadow-red-600/30 mb-6">
            <Wrench className="w-10 h-10 text-white" />
          </div>
          
          <h1 className="text-4xl font-black text-white tracking-tight mb-1" style={{ fontFamily: "'Orbitron', sans-serif" }}>
            MECÁNICA
          </h1>
          <h2 className="text-5xl font-black text-red-500 tracking-tight" style={{ fontFamily: "'Orbitron', sans-serif" }}>
            PISTÓN
          </h2>
